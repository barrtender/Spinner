...
public class MyView extends View {
	private String mExampleString = "hello custom view"; // TODO: use a default from R.string...
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		mExampleString = "hello custom view";// a.getString(R.styleable.MyView_exampleString);
